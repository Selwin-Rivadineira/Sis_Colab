...
// COMENTARIO: Se eliminó la variable CORPORATE_DOMAIN, ya no hay restricción de dominio.
...
wss.on('connection', async (ws, req) => {
    ...
    try {
        ...
        // --- CÓDIGO ELIMINADO/COMENTADO (RESTRICCIÓN DE DOMINIO) ---
        // Anteriormente se verificaba el dominio, ahora esta lógica es omitida.
        // --- FIN CÓDIGO ELIMINADO/COMENTADO ---
...
console.log('Servidor WebSocket activo en http://localhost:8081');